...
public class GdxTestBase {
    ...
    static class HeadlessTestApplication implements ApplicationListener {
    ...
    static class MockGL20 implements GL20 {
        // Implement all GL20 methods with empty bodies or return defaults
        // For example:
        ...
        @Override
        public void glCompressedTexImage2D(int i, int i1, int i2, int i3, int i4, int i5, int i6,
            Buffer buffer) {

        }

        @Override
        public void glCompressedTexSubImage2D(int i, int i1, int i2, int i3, int i4, int i5, int i6,
            int i7, Buffer buffer) {

        }

        @Override
        public void glCopyTexImage2D(int i, int i1, int i2, int i3, int i4, int i5, int i6,
            int i7) {

        }

        @Override
        public void glCopyTexSubImage2D(int i, int i1, int i2, int i3, int i4, int i5, int i6,
            int i7) {
        ...
        // ... implement all required methods similarly ...
        @Override public int glGenTexture() {
            return 0;
        }
        ...
        @Override
        public void glTexImage2D(int i, int i1, int i2, int i3, int i4, int i5, int i6, int i7,
            Buffer buffer) {
        ...
        @Override
        public void glTexSubImage2D(int i, int i1, int i2, int i3, int i4, int i5, int i6, int i7,
            Buffer buffer) {
        ...
        @Override
        public void glGetFramebufferAttachmentParameteriv(int i, int i1, int i2,
            IntBuffer intBuffer) {
        ...
        @Override
        public void glGetShaderPrecisionFormat(int i, int i1, IntBuffer intBuffer,
    ...
    public static void init() {
        if (!initialized) {
            ...
            application = new HeadlessApplication(new HeadlessTestApplication(),
                config);
            Gdx.gl = new MockGL20();
            Gdx.gl20 = Gdx.gl;
            initialized = true;
